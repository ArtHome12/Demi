...
void World::makeTick()
{
	...
	// Значения массива arResMax, используемые для выбора цвета точки по самому относительно концентрированному элементу в ней, сейчас всегда только растут от самого первого тика модели, что очевидно не совсем корректно.
